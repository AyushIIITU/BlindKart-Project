...
// Example usage of the getKey function
// var divKey = getKey({
//     keyCode: 65, // Replace this with the desired key code
//     location: KeyboardEvent.DOM_KEY_LOCATION_LEFT,
//     // Add any other properties that your event listener might use
// });

// if (divKey) {
//     var keyData = divKey.dataset.char; // Assuming the key data is stored in the data-char attribute
//     console.log('Key data:', keyData);
// } else {
//     console.warn('No key found for the specified keyCode');
// }
